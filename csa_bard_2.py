    ...
    def evolve(self, target_function):
        ...
        while True:
            ...
            for i in range(self.population_size):
                ...
                # With probability awareness_probability, follow the path of another crow
                if random.random() < self.awareness_probability:
                    best_solution = None
                    best_fitness = float("inf")
                    for other_solution, other_fit in zip(new_population, fitness):
                        if other_fit < best_fitness:
                            best_solution = other_solution
                            best_fitness = other_fit
